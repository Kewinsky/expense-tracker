...
import AnalyzerPage from "../pages/dashboardPage/DashboardPage";
import ErrorPage from "../pages/notFoundPage/NotFoundPage";
import HomePage from "../pages/homePage/HomePage";
import LoginPage from "../pages/loginPage/LoginPage";
import ProfilePage from "../pages/profilePage/ProfilePage";
import RegisterPage from "../pages/registerPage/RegisterPage";
import TrackerPage from "../pages/expensesPage/ExpensesPage";
import UnauthorizedPage from "../pages/unauthorizedPage/UnauthorizedPage";
import UserManagementPage from "../pages/usersPage/UsersPage";
...
import UserCategoriesPage from "../pages/categoriesPage/categoriesPage";
import IncomePage from "../pages/incomesPage/IncomesPage";
